...
<div class="container">
    <div class="row justify-content-center align-items-center flex-wrap d-flex pt20">
        ...
        <div class="col-md-6 col-lg-7 col-sm-7 text-lg-right">
            <a href="#checkOnlineAdmissionStatus" class="modalclosebtn modal-close-xs w-full-xs mr-lg-1" onclick="openStatusFormmodal();" data-bs-toggle="modal" data-bs-target="#checkOnlineAdmissionStatus"><?php echo $this->lang->line('check_your_form_status') ?></a>
...
<div id="checkOnlineAdmissionStatus" aria-labelledby="checkOnlineAdmissionStatus" aria-hidden="true" class="modal fade" role="dialog" tabindex="-1">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header modal-header-small">
        <button type="button" class="close closebtnmodal" data-bs-dismiss="modal" aria-label="Close">&times;</button>
