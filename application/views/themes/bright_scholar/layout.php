...
<head>
    ...
    <meta name="title" content="<?php if (isset($page['meta_title'])) {
                                    echo $page['meta_title'];
                                } ?>">
    <meta name="keywords" content="<?php if (isset($page['meta_keyword'])) {
                                        echo $page['meta_keyword'];
                                    } ?>">
    <meta name="description" content="<?php if (isset($page['meta_description'])) {
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Plus+Jakarta+Sans:ital,wght@0,200..800;1,200..800&family=Tiro+Bangla:ital@0;1&display=swap"
        rel="stylesheet">
    ...
    <link href="<?php echo $base_assets_url; ?>css/base_style.css?v=<?php echo filemtime(strval($base_assets_url).'css/style.css'); ?>" rel="stylesheet">
    <link href="<?php echo $base_assets_url; ?>css/style.css?v=<?php echo filemtime(strval($base_assets_url).'css/style.css'); ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/venobox@2.1.8/dist/venobox.css">
</head>
                            ...
                            <?php if ($this->module_lib->hasModule('online_course') && $this->module_lib->hasActive('online_course')) {
                                if ($guest_login == 0) {
                                    if ($setting_data[0]['student_panel_login']) { ?>
                                        ...
                                        <a href="<?php echo base_url(); ?>site/userlogin"><i class="fa fa-user"></i><?php echo $this->lang->line('student'); ?> / <?php echo $this->lang->line('Parent'); ?></a>
    ...
    <main>
        <div class="w-full">
            ...
            if ($page_side_bar) {
                ...
                $page_colomn = "col-md-9 col-sm-9 emon2";
            }
            ?>
            <div>
                <?php echo $content; ?>
                                ...
                                <div class="tickercontainer">
                                    <div class="mask">
                                        <ul id="ticker01" class="newsticker" style="height: 666px; top: 124.54px;">
                                            ...
                                            ?>
                                                    <li><a href="<?php echo site_url('read/' . $banner_notice_value['slug']) ?>">
                                                            <div class="datenews"><?php echo date('d', strtotime($banner_notice_value['date'])); ?><span><?php $this->lang->line(strtolower(date('F', strtotime($banner_notice_value['date'])))); ?></span></div><?php echo $banner_notice_value['title']; ?>
                                                        </a></li>
                                            <?php
                                                }
                                            }
        ...
        <script>
            ...
            $(document).ready(function() {
                $('.owl-carousel').owlCarousel({
                    ...
                    nav: true,
                    dots: false,
                    navText: [`<span class="flaticon-forward"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-left"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 6l-6 6l6 6" /></svg></span>`, `<span class="flaticon-back"> <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-chevron-right"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9 6l6 6l-6 6" /></svg></span>`],
                    animateOut: 'fadeOut',
                    responsive: {
                        0: {
                            nav: false,
