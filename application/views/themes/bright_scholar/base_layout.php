...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            if ($page_side_bar) {
                $page_colomn = "col-md-9 col-sm-9 emon1";
            }
            ?>
            <div class="<?php echo $page_colomn; ?> emon1">
                <?php echo $content; ?>
            </div>
            <?php
            if ($page_side_bar) {
                                        ...
                                        <ul id="ticker01" class="newsticker" style="height: 666px; top: 124.54px;">
                                            ...
                                            ?>
                                                    <li><a href="<?php echo site_url('read/' . $banner_notice_value['slug']) ?>">
                                                            <div class="date_item"><?php echo date('d', strtotime($banner_notice_value['date'])); ?><span><?php $this->lang->line(strtolower(date('F', strtotime($banner_notice_value['date'])))); ?></span></div><?php echo $banner_notice_value['title']; ?>
                                                        </a></li>
                                            <?php
                                                }
                                            }
