...
?>
        ...
        <script>window.gtranslateSettings = {"default_language":"ar","native_language_names":true,"languages":["en","ar","fr","de","it","es","hi"],"wrapper_selector":".gtranslate_wrapper"}</script>
...
?>
        ...
        <script type="text/javascript">
            ...
            function toggleDropdown() {
                if ($(window).width() < 768) { // Mobile device width
